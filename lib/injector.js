...
function Injector(init) {
  this.graph = new require('dependency-graph').DepGraph();

  // raw[key].type: 'fn', 'const', 'var'
  // raw[key].value: anything
  // raw[key].deps: ['depName']
  this.raw = {};
}
...
Injector.prototype.addFunc = function() {};


Injector.prototype.addModule = function() {};
